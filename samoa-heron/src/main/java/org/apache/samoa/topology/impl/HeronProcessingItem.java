...
import org.apache.samoa.topology.impl.HeronStream.InputStreamId;
 ...
 * 
 */
class HeronProcessingItem extends AbstractProcessingItem implements HeronTopologyNode {
  ...
  protected ProcessingItem addInputStream(Stream inputStream, PartitioningScheme scheme) {
    HeronStream heronInputStream = (HeronStream) inputStream;
    InputStreamId inputId = heronInputStream.getInputId();
